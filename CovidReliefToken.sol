 ...
 * 
 *  At each transaction:
 *  - %5 is added to charity wallet
 *  - %1 is burnt
 *  - %2 is distributed to $CRT holders
 *  
 *  Set slippage to         8% - 10%
 *
 *  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 *  
 *  Telegram : https://t.me/CovidReliefToken
 *  Twitter  : https://twitter.com/CovidReliefToken
 * 
 */
...
contract CovidReliefToken is Context, IERC20, Ownable {
    ...
    string private _name = "CovidReliefToken";
    ...
    uint256 private numTokensSellToAddToCharity = 5 * 10**4 * 10**9;
